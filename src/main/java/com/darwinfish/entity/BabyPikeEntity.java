...
public class BabyPikeEntity extends Salmon implements BabyFishEntity {

    private int ageTicks;

    public BabyPikeEntity(EntityType<? extends BabyPikeEntity> type, Level level) {
        super(type, level);
    ...
    private void growUp() {
        ...
        // Превращаемся именно в щуку
        PikeEntity adult = ModEntities.PIKE.get().create(sl);
        if (adult != null) {
